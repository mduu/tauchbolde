...
{
    public class PublishNewEventPolicyTests
    {
        [NotNull] private readonly PublishNewEventPolicy policy;
        [NotNull] private readonly ILogger<PublishNewEventPolicy> logger = A.Fake<ILogger<PublishNewEventPolicy>>();
        ...
        private EventCreatedEvent CreateNotification(Guid? eventId = null) => new EventCreatedEvent(eventId ?? validEventId);
    }
}