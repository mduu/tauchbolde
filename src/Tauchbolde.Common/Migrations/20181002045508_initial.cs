        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Diver_IdentityUser_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(nullable: false),
                    OrganisatorId = table.Column<Guid>(nullable: false),
                    Location = table.Column<string>(nullable: true),
                    MeetingPoint = table.Column<string>(nullable: true),
                    Description = table.Column<string>(nullable: true),
                    StartTime = table.Column<DateTime>(nullable: false),
                    EndTime = table.Column<DateTime>(nullable: true),
                    Canceled = table.Column<bool>(nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Diver_OrganisatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Diver_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Diver",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_Diver_RecipientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diver_UserId1",
                table: "Diver",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_Events_OrganisatorId",
                table: "Events",
                column: "OrganisatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_StartTime_Deleted",
                table: "Events",
                columns: new[] { "StartTime", "Deleted" });
